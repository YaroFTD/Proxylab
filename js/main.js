   ...
   const swiper = new Swiper('.reviews__slider', {
      ...
      pagination: {
         ...
         renderBullet: function (index, className) {
            if (index + 1 <= 5) {
               return '<span class="' + className + ' ' + className + '-' + (index + 1) + ' ' + className + '-middle'+'"><img src="img/reviews/0'+(index+1)+'.png" alt=""></span>';
            } else if (index + 1 <= 9) {
               return '<span class="' + className + ' ' + className + '-' + (index + 1) + ' ' + className + '-last'+'"><img src="img/reviews/0'+(index+1)+'.png" alt=""></span>';
            }
         },
      },
      ...
      on: {
         slideChange: function () {
            ...
            let activeSlide = document.querySelector('.swiper-pagination-bullet-active');
            let firstSlide = document.querySelector('.swiper-pagination-bullet-1');
            let activeClass = activeSlide.getAttribute('class').split(' ').splice(0, 3).join(' ');
            let arr1 = activeClass.split(' ');
            let arr2 = activeClass.split(' ');
            arr1.splice(1, 0, 'swiper-pagination-bullet-1');
            arr2.splice(1, 0, 'swiper-pagination-bullet-1 swiper-pagination-bullet-active');
            if (index_currentSlide == 0) {
               firstSlide.setAttribute('class', arr2.join(' '))
            } else {
               firstSlide.setAttribute('class', arr1.join(' '))
            }
         },
      },
   });
